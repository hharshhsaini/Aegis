...
test('conditional-request validators and gzip ride along with feed identification', () => {
  ...
  assert.equal(plain['ET-Client-Name'], 'aegis-transit');
  ...
  assert.match(conditional['User-Agent'], /aegis/);
});
