...
import { flyToInitialView } from '../camera.js';
...
export function createApplicationControls({
  ...
  // A share link carries its own camera; only an unshared start needs framing.
  if (!styleManager.hasShareState) {
    loaderStatus.textContent = 'Framing regional view...';
    defer(flyToInitialView(viewer));
  } else {
