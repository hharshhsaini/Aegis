export const ACTION_DESCRIPTIONS = {
  fly_to_location: {
    description:
      'Fly the Aegis camera to a known city, geocoded country/region/city/landmark, or explicit WGS84 coordinate. Countries/cities frame the whole place; landmarks/buildings use close framing.',
    $position: 1,
    parameters: {
      properties: {
        locationId: {
        ...
        viewMode: {
          description:
            'Optional framing intent. Usually omit this; Aegis infers whole-place framing for countries/cities and close framing for landmarks.',
          $position: 2,
        },
        rangeM: {
          description:
  ...
  set_layer_visibility: {
    description: 'Enable or disable one registered Aegis data layer.',
    $position: 1,
    parameters: {
      properties: {
        layerId: {
  ...
  set_panel_open: {
    description: 'Open or close an Aegis UI panel/dropdown.',
    $position: 1,
  },
  set_context_mode: {
    description:
  ...
  set_visual_style: {
    description: 'Set the active Aegis visual filter/style.',
    $position: 1,
  },
  get_entity_context: {
    description:
      'Get current Aegis scene context, including basemap/3D-tile target context, selected entity metadata if active, and entities currently visible in the camera view.',
    $position: 1,
    parameters: {
      properties: {
        scope: {
